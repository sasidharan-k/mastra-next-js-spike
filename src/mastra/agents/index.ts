...
const getBingAgent = async () => {
  // const modifiedTool = createTool({
  //   id: 'bing-search',
  //   description: tool['weather_bing-agent'].description,
  //   inputSchema: tool['weather_bing-agent'].inputSchema,
  //   outputSchema: z.object({
  //       result: z.string()
  //     }),
  //   execute: tool['weather_bing-agent'].execute,
  // })

  const bingAgent = new Agent({
    name: "Bing Agent",
    instructions: `
...
export const bingAgent = await getBingAgent();
